...
export class PublishersService {
  ...
  addWebsite(publisherId: string, data: any): Promise<any> {
    return this.client.post(`/publishers/${publisherId}/websites`, { json: data })
  }

  updateWebsite(publisherId: string, websiteId: string, data: any): Promise<any> {
    return this.client.put(`/publishers/${publisherId}/websites/${websiteId}`, { json: data })
  }

  deleteWebsite(publisherId: string, websiteId: string): Promise<any> {
    return this.client.delete(`/publishers/${publisherId}/websites/${websiteId}`)
  }
