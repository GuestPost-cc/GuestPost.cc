...
const FINANCE_AUDIT_ACTIONS = [
  ...
  "WITHDRAWAL_REVERSED",
  "PAYOUT_METHOD_DEACTIVATED",
  "PAYOUT_METHOD_DEACTIVATION_REPLAYED",
  "PAYOUT_METHOD_REACTIVATED",
  "PAYOUT_METHOD_REACTIVATION_REPLAYED",
  "PAYOUT_PROVIDER_RESPONSE_QUARANTINED",
