...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    if (user.userType === "CUSTOMER") {
      setError(
        "This account is registered as a customer. Open the Customer portal or use another account.",
      )
      return
    }
  ...
  return (
    <AuthLayout>
      <AuthCard
        ...
        description="Sign in to manage websites, listings, orders, earnings, and payouts."
        footer={
          <p>
            Want to publish with GuestPost?{" "}
            <Link
              href={signupHref}
