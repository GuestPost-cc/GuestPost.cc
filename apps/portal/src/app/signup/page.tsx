  ...
  useEffect(() => {
    ...
    setError(
      user.userType === "PUBLISHER"
        ? "This Google account already belongs to a publisher. Customer and publisher accounts must use different email addresses."
        : "Staff accounts cannot be used to create a customer account.",
    )
  ...
  return (
    <AuthLayout>
      <AuthCard
        ...
        title="Create your customer workspace"
        description="Start a buyer account to discover publishers and manage campaigns."
        footer={
          <p>
