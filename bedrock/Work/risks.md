...
- ~~Partial structured-logger sweep (Phase 7.7 B)~~ — **CLOSED** by Phase 7.7.x (commit `5af902c`). All 8 worker files swept; allowlist at its forever-allowed steady state.
